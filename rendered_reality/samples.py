...
def drive_chatgpt_return_from_dark_doc() -> Receipt:
    ...
    return Receipt(
        ...
        submitted_by="Noah.Physical",
        original_author="Noah.Physical",
        authorship_status=Authorship.NOAH_AUTHORIZED_AI_ASSISTED,
        author_confidence=0.95,
        authorial_authority="Noah.Physical",
        intent_owner="Noah.Physical",
        produced_with="chatgpt",
        token_origin="ai",
        origin_channel="ai_assisted_thread_pass",
        reviewed_by="Noah.Physical",
